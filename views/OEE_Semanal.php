...
function Header()
{
    ...
    $this->Cell(65);
    // Título
    $this->Cell(35,10,utf8_decode('REPORTE DE EFICIENCIA OEE'));
...
$result = $conn->query("SELECT * FROM `eficiencias` WHERE `ef_turno` = '".$code."' and `ef_sem` = '".$semana."' ");
...
$disp1_m1 = substr(($time/(9*$count))*100,0,4);
$calidad1_m1 = 93.5;
...
$disp1_m2 =substr(($time_1/(9*$count))*100,0,4);
$calidad1_m2 = 90.5;
...
$disp1_m3 = substr(($time_2/(9*$count))*100,0,4);
$calidad1_m3 = 96.3;
...
$pdf->AddPage();
  ...
  //$pdf->Cell(100,5,"Series",0,0,'C');
	...
	$conn = mysqli_connect("localhost", "admin_cinvyciot", "contrDBinfoGlobTraficRegUsrMpC", "admin_IoTusers");
	$result1 = $conn->query("SELECT * FROM `eficiencias` WHERE `ef_turno` = '".$code1."' and `ef_sem` = '".$semana."' ");
...
$day= date("j");
				...
				$conn = mysqli_connect("localhost", "admin_cinvyciot", "contrDBinfoGlobTraficRegUsrMpC", "admin_IoTusers");
				$result2 = $conn->query("SELECT * FROM `eficiencias` WHERE  `ef_sem` = '".$semana."' and `ef_dia`  != '".$day."'");
				$almacen2 = $result2->fetch_all(MYSQLI_ASSOC);

				$count2 = count($almacen2);
				...
				$pdf->Cell(30,5,Turno,1,0, 'C', true);
				$pdf->Cell(30,5,Prod_Real ,1,0, 'C', true);
				$pdf->Cell(32,5,'Tiempo_operativo (Hrs)' ,1,0, 'C', true);
				$pdf->Cell(30,5,'%'.Disponibilidad,1,0, 'C', true);
				$pdf->Cell(30,5,'%'.Rendimiento ,1,0, 'C', true);
				$pdf->Cell(30,5,'%'.Calidad,1,0, 'C', true);
				$pdf->Cell(30,5,'%'.OEE,1,1, 'C', true);
...
////////////////////////// Maquina 1 ////////////////////////////////////////////////
					...
					$pdf->Cell(30,6,$A_fecha.'-'.$M_fecha.'-'.$D_fecha,1,0, 'C', 0);
					$pdf->Cell(30,6,$M2['ef_turno'],1,0, 'C', 0);
					$pdf->Cell(30,6,$M2['ef_maq1'],1,0, 'C', 0);
					$time2 = $M2['ef_timem1'];
					$pdf->Cell(32,6,$time2,1,0, 'C', 0);

					$ef = $M2['ef_maq1'];
					$disp1_m1 = substr(($time2/9)*100,0,4);
					$pdf->Cell(30,6,$disp1_m1.'%',1,0, 'C', 0);


					$real_m1 = $time2*22000;
					$prod1_m1 = substr(($ef1/$real_m1)*100,0,4);
					$pdf->Cell(30,6,$prod1_m1.'%',1,0, 'C', 0);
...
/////////////////////////// Maquina 2 ////////////////////////////////////////////////
				  ...
				  $pdf->Cell(30,6,'Maquina2',1,0, 'C', true);
					...
					$A_fecha1 = $M2['ef_date1'];
					$M_fecha1 = $M2['ef_mes'];
					$D_fecha1 = $M2['ef_dia'];

					$pdf->Cell(30,6,$A_fecha1.'-'.$M_fecha1.'-'.$D_fecha1,1,0, 'C', 0);
					$pdf->Cell(30,6,$M2['ef_turno'],1,0, 'C', 0);
					$pdf->Cell(30,6,$M2['ef_maq2'],1,0, 'C', 0);
					$time = $M2['ef_timem2'];
					$pdf->Cell(32,6,$time,1,0, 'C', 0);

					$ef2 = $M2['ef_maq2'];
					$disp1_m2 = substr(($time/9)*100,0,4);
					$pdf->Cell(30,6,$disp1_m2.'%',1,0, 'C', 0);

					$real_m2 = $time*3500;
					$prod1_m2 = substr(($ef2/$real_m1)*100,0,4);
					$pdf->Cell(30,6,$prod1_m2.'%',1,0, 'C', 0);
...
/////////////////////////// Maquina 3 ////////////////////////////////////////////////
        	...
        	$pdf->Cell(5);
					...
					$A_fecha2 = $M2['ef_date1'];
					$M_fecha2 = $M2['ef_mes'];
					$D_fecha2 = $M2['ef_dia'];

					$pdf->Cell(30,6,$A_fecha2.'-'.$M_fecha2.'-'.$D_fecha2,1,0, 'C', 0);
					$pdf->Cell(30,6,$M2['ef_turno'],1,0, 'C', 0);
					$pdf->Cell(30,6,$M2['ef_maq3'],1,0, 'C', 0);
					$time1 = $M2['ef_timem3'];
					$pdf->Cell(32,6,$time1,1,0, 'C', 0);

					$ef2 = $M2['ef_maq3'];
					$disp1_m3 = substr(($time1/9)*100,0,4);
					$pdf->Cell(30,6,$disp1_m3.'%',1,0, 'C', 0);

					$real_m3 = $time1*3500;
					$prod1_m1 = substr(($ef2/$real_m3)*100,0,4);
					$pdf->Cell(30,6,$prod1_m1.'%',1,0, 'C', 0);
...
/////////////////////////// Maquina 4 ////////////////////////////////////////////////
				...
				$A_fecha3 = $M2['ef_date1'];
				$M_fecha3 = $M2['ef_mes'];
				$D_fecha3 = $M2['ef_dia'];

				$pdf->Cell(30,6,$A_fecha3.'-'.$M_fecha3.'-'.$D_fecha3,1,0, 'C', 0);
				$pdf->Cell(30,6,$M2['ef_turno'],1,0, 'C', 0);
				$pdf->Cell(30,6,$M2['ef_maq1'],1,0, 'C', 0);
				$time2 = $M2['ef_timem1'];
				$pdf->Cell(32,6,$time2,1,0, 'C', 0);
...
/////////////////////////// Maquina 5 ////////////////////////////////////////////////
				...
				$A_fecha4 = $M2['ef_date1'];
				$M_fecha4 = $M2['ef_mes'];
				$D_fecha4 = $M2['ef_dia'];

				$pdf->Cell(30,6,$A_fecha4.'-'.$M_fecha4.'-'.$D_fecha4,1,0, 'C', 0);
				$pdf->Cell(30,6,$M2['ef_turno'],1,0, 'C', 0);
				$pdf->Cell(30,6,$M2['ef_maq2'],1,0, 'C', 0);
				$time = $M2['ef_timem2'];
				$pdf->Cell(32,6,$time,1,0, 'C', 0);
